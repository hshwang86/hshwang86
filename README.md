...
<a href="https://github.com/hshwang86"><img src="https://img.shields.io/github/followers/hshwang86?label=Follow&style=for-the-badge&logo=github&color=181717" alt="GitHub followers"/></a>
<img src="https://komarev.com/ghpvc/?username=hshwang86&style=for-the-badge&color=blueviolet" alt="profile views"/>
...
- 🚌 **MobilHi ERP** — 시내버스 운수업에 특화된 통합 ERP (배차, 급여, 인센티브 계약, 법규 준수 관리). 여러 운수 회사에 서비스 중. Django 5 · DRF · PostgreSQL · React.
- 📱 **Field Mobile Apps** — 운전자 음주측정 관리 등 현장 업무용 Flutter 앱. REST + JWT로 ERP 백엔드와 연동, Firebase 푸시 알림 지원.
- 🤖 **AI Automation** — FastAPI + Claude/OpenAI 에이전트 기반 비즈니스 영상 제작 및 ERP 고객지원 자동화 파이프라인.
...
- **㈜서울소프트 · 개발이사** `2020.10 – 현재`
  - 시내버스 통합 ERP **'MobilHi'** 설계·개발 총괄 — 배차/인사/급여/회계/수입금/정비/사고·민원/재고/시설/운행기록/운행평가/FMS 등 16개 모듈 (Django · DRF · PostgreSQL · React · AWS)
  - 성남·전주·춘천·강진·공항버스 등 **다수 운수사 맞춤 구축·운영**, 택시 ERP 데모 개발
  - 현장 모바일 앱 개발 — 운전자 음주측정 컴플라이언스 시스템(웹+앱), 운수사 ERP 연동 앱 (Flutter · Firebase FCM)
  - 사내 그룹웨어 **'SS Groupware'** 개발 — 멀티테넌트 브랜딩, 휴가/결재, Celery 비동기 처리
  - 스마트공장 **MES** 개발 — IoT 버튼 연동 (MQTT · WebSocket · FCM)
  - 업무 자동화 — DTG(디지털 운행기록계) 데이터 분석, 인센티브 계약서/보안서약서 문서 자동 생성
...
<img src="https://img.shields.io/badge/ccxt%20%2F%20Binance-F0B90B?style=for-the-badge&logo=binance&logoColor=black" alt="ccxt / Binance"/>
...
- AI 기반 고급 트레이딩 전략과 멀티 타임프레임 시장 분석
- Kubernetes를 활용한 분산 시스템과 컨테이너 오케스트레이션
- 업무 프로세스 자동화를 위한 에이전틱 AI 워크플로우

## 💬 Ask Me About

- 대중교통 ERP 시스템 (배차, 급여, 컴플라이언스)
- Django, Python, Flutter, PostgreSQL
- Unity · Unreal · Cocos2d/Cocos2d-x 게임 개발, VR 콘텐츠
- 알고리즘 트레이딩, 리스크 관리, 프롬프트 엔지니어링
- API 연동, 데이터 파이프라인, AI 에이전트 자동화
